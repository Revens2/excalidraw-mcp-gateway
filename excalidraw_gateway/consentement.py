"""Page de consentement du flux OAuth de la passerelle Excalidraw.
...
from excalidraw_gateway.oauth import (
    PORTEE,
    PORTEE_ECRITURE,
    FournisseurOAuth,
    verifier_phrase,
...
VARIABLE_EMPREINTE = "EXCALIDRAW_MCP_CONSENT_HASH"

_GABARIT = """<!doctype html>
<html lang="fr"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Autoriser l'acces a Excalidraw</title>
<style>
...
<h1>Autoriser l'acces a Excalidraw</h1>
<p>Le client <strong>{client}</strong> demande les acces suivants sur vos
...
_LIBELLES = {
    PORTEE: ("Lire", "vos diagrammes (aide au format, lecture des checkpoints)"),
    PORTEE_ECRITURE: ("Creer et modifier", "des diagrammes (rendu, sauvegardes, partage excalidraw.com)"),
}
